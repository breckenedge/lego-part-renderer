...
echo "  2. Check health:     curl http://localhost:5346/health"
echo "  3. Test render:      curl -X POST http://localhost:5346/render -H 'Content-Type: application/json' -d '{\"partNumber\":\"3001\"}' -o test.svg"
